pipeline {
    ...
    stages {
        ...
        stage('Upload to Nexus') {
            steps {
                // Deploy to Nexus
                nexusArtifactUploader credentialsId: 'nexus', groupId: 'com.maven.bt', nexusUrl: '172.31.1.76:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'maven-release', version: '9.1.14'
