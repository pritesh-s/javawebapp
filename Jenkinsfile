    ...
    stages {
        ...
        stage('Upload to Nexus') {
            steps {
                // Deploy to Nexus
                sh 'pwd'
               nexusArtifactUploader artifacts: [[artifactId: 'SimpleWebApplication', classifier: '', file: 'target/SimpleWebApplication.war', type: 'war']], credentialsId: 'nexus', groupId: 'com.maven.bt', nexusUrl: '172.31.1.76:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'maven-jenkins-release', version: '9.1.14'
